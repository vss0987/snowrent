...
SECRET_KEY = 'django-insecure-$upkfl2y&rjoghexa^p*(jh(e3=m@&%)0r2!@ur%a&w7df2o#m'
...
CELERY_BEAT_SCHEDULE = {
    'release-expired-carts': {
        ...
        'schedule': 60.0,  # Проверяем каждую минуту (можно оставить 300.0 для проверки каждые 5 минут)
    },
